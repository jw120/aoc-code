...
import AOC_2021_18 (SnailNumber, add, addList, magnitude, readSnail, reduce, showSnail)
...
unit_2021_18_snail_add2 :: IO ()
unit_2021_18_snail_add2 =
    showSnail
        ( add
            (readSnail "[[[0,[4,5]],[0,0]],[[[4,5],[2,6]],[9,5]]]")
            (readSnail "[7,[[[3,7],[4,3]],[[6,3],[8,8]]]]")
        )
...
unit_2021_18_snail_add_list5 :: IO ()
unit_2021_18_snail_add_list5 = showSnail (addList test1) @?= "[[[[6,6],[7,6]],[[7,7],[7,0]]],[[[7,7],[7,7]],[[7,8],[9,9]]]]"

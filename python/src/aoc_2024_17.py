...
class Computer:
    ...
    def run(self, ip: int | None = None, *, debug: bool) -> None:
    ...
    def step(self, *, debug: bool) -> None:
        ...
        if debug:
            print(
                f"A={bin(self.a)}, B={bin(self.b)}, C={bin(self.c)}, ip={self.ip} ({opcode}, {operand_code}->{operand})",
                end=" ",
            )

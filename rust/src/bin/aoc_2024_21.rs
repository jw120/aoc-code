struct NumPadPosition(u8);

// Rows represent connections from each numeric pad position
// Within each row, order is Up, Right, Down, Left
const NUM_CONNECTIONS: [[Option<usize>; 4]; 11] = [
